...
CREATE TABLE notification (login VARCHAR NOT NULL, userid INT NOT NULL, issueid INT NOT NULL, text VARCHAR, id SERIAL NOT NULL, CONSTRAINT notification_id_pk PRIMARY KEY (id));
